...
#One = plt.errorbar(np.arange(epochs),TrainMSE[0], color = 'C7', label = 'Rate = 0.001')
#Two = plt.errorbar(np.arange(epochs),TrainMSE[1], color = 'C8', label = 'Rate = 0.01')
#Three = plt.errorbar(np.arange(epochs),TrainMSE[2], color = 'C5', label = 'Rate = 0.1')
#Four = plt.errorbar(np.arange(epochs),TrainMSE[3], color = 'C3', label = 'Rate = 0.5')
#Five = plt.errorbar(np.arange(epochs),TrainMSE[4], color = 'C4', label = 'Rate = 1.0')
#Six = plt.errorbar(np.arange(epochs),TrainMSE[5], color = 'C2', label = 'Rate = 1.5')
#Seven = plt.errorbar(np.arange(epochs),TrainMSE[6], color = 'C1', label = 'Rate = 2.0')
#Eight = plt.errorbar(np.arange(epochs),TrainMSE[7], color = 'C6', label = 'Rate = 5.0')
#Nine = plt.errorbar(np.arange(epochs),TrainMSE[8], color = 'C9', label = 'Rate = 10.0')
...
#Four = plt.errorbar(np.arange(50),TrainMSE[3][0:50], color = 'C3', label = 'Rate = 0.5')
#Five = plt.errorbar(np.arange(50),TrainMSE[4][0:50], color = 'C4', label = 'Rate = 1.0')
#Six = plt.errorbar(np.arange(50),TrainMSE[5][0:50], color = 'C2', label = 'Rate = 1.5')
#Seven = plt.errorbar(np.arange(50),TrainMSE[6][0:50], color = 'C1', label = 'Rate = 2.0')
#Eight = plt.errorbar(np.arange(50),TrainMSE[7][0:50], color = 'C6', label = 'Rate = 5.0')
#Nine = plt.errorbar(np.arange(50),TrainMSE[8][0:50], color = 'C9', label = 'Rate = 10')
...
#plt.ylabel("MSE")
#plt.legend(handles = [One,Two,Three,Four,Five,Six,Seven,Eight,Nine,Ten,Eleven], loc = 1)
...
#plt.figure()
#figure(num=None, figsize=(8, 6), dpi=80, facecolor='w', edgecolor='k')
##One = plt.errorbar(np.arange(epochs),TestMSE[0], color = 'C7', label = 'Rate = 0.001')
##Two = plt.errorbar(np.arange(epochs),TestMSE[1], color = 'C8', label = 'Rate = 0.01')
##Three = plt.errorbar(np.arange(epochs),TestMSE[2], color = 'C5', label = 'Rate = 0.1')
##Four = plt.errorbar(np.arange(epochs),TestMSE[3], color = 'C3', label = 'Rate = 0.5')
##Five = plt.errorbar(np.arange(epochs),TestMSE[4], color = 'C4', label = 'Rate = 1.0')
##Six = plt.errorbar(np.arange(epochs),TestMSE[5], color = 'C2', label = 'Rate = 1.5')
...
#
#Four = plt.errorbar(np.arange(50),TestMSE[3][0:50], color = 'C3', label = 'Rate = 0.5')
#Five = plt.errorbar(np.arange(50),TestMSE[4][0:50], color = 'C4', label = 'Rate = 1.0')
#Six = plt.errorbar(np.arange(50),TestMSE[5][0:50], color = 'C2', label = 'Rate = 1.5')
#Seven = plt.errorbar(np.arange(50),TestMSE[6][0:50], color = 'C1', label = 'Rate = 2.0')
#Eight = plt.errorbar(np.arange(50),TestMSE[7][0:50], color = 'C6', label = 'Rate = 5.0')
#Nine = plt.errorbar(np.arange(50),TestMSE[8][0:50], color = 'C9', label = 'Rate = 10')
...
#plt.title("Testing Mean Squared Error vs. Number of Epochs")
#plt.xlabel("Number of Epochs")
#plt.ylabel("MSE")
##plt.legend(handles = [One,Two,Three,Four,Five,Six,Seven,Eight,Nine,Ten,Eleven], loc = 1)
#plt.legend(handles = [Four,Five,Six,Seven,Eight,Nine,Ten,Eleven], loc = 1)
